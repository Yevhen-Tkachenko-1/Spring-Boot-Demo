...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, TARGET_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C1'), (SELECT GUEST_ID FROM GUEST WHERE EMAIL_ADDRESS = 'kwrightf@tinyurl.com'), '2022-01-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, TARGET_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT GUEST_ID FROM GUEST WHERE EMAIL_ADDRESS = 'jwright1q@phoca.cz'), '2022-02-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, TARGET_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C3'), (SELECT GUEST_ID FROM GUEST WHERE EMAIL_ADDRESS = 'jyoung11@goodreads.com'), '2022-03-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, TARGET_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'V1'), (SELECT GUEST_ID FROM GUEST WHERE EMAIL_ADDRESS = 'jwoodn@mtv.com'), '2022-01-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, TARGET_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'V2'), (SELECT GUEST_ID FROM GUEST WHERE EMAIL_ADDRESS = 'jwood1k@goodreads.com'), '2022-02-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, TARGET_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'V3'), (SELECT GUEST_ID FROM GUEST WHERE EMAIL_ADDRESS = 'vwright7@baidu.com'), '2022-03-01');
